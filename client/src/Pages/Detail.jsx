...
const ProductSection = () => {
  ...
  const addToFavorite = async () => {
    try {
      const response = await axios.post("http://localhost:8000/postfav", {
        product_id: id,
      });
      if (response.status === 201) {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/Get_Product_By_Id/${id}`)
      .then((response) => {
      ...
      <div className="container px-5 py-40 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            ...
            src={blogImages.product_image}
          />
          {/* <img className="w-full" src={blogImages[2].image_url} alt={blogPost.product_name} /> */}
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h1 className="flex text-gray-900 text-3xl title-font font-medium mb-4">
              {blogPost.product_name}
            </h1>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <button
                    ...
                    className="bg-teal-600 w-6 h-6 focus:outline-none"
                  >
                    +
                  </button>
                </div>
                <div className="flex ml-6 items-center">
                  ...
                  <input
                    type="text"
                    value={blogPost.discount_percentage}
                    className="border-0 border-gray-300 w-10 h-6 text-center focus:outline-none"
                    readOnly
                  />
                </div>
                %
            ...
            <div className="flex">
              ...
              <button
                onClick={addToCart}
                className="flex ml-60 text-white bg-teal-600 border-0 py-2 px-6 focus:outline-none hover:bg-teal-600 rounded "
              >
                Add to Cart
              </button>
