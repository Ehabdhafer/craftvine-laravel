...
const BestSellery = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/getbest")
      .then((response) => {
  ...
  return (
    <div className="my-16">
      <h1 className="text-teal-600 text-4xl mb-6 font-bold item-center justify-center text-center">
        Best Sellery (Price Less than 100$)
      </h1>
